...
bin/main: obj/main.o obj/board.o obj/game.o obj/graphics.o
	g++ obj/main.o obj/board.o obj/game.o obj/graphics.o -o bin/main -L$(SFML_PATH)/lib $(SFML_LIBS)
...
obj/graphics.o: src/graphics.cpp src/graphics.h
	g++ -c src/graphics.cpp -o obj/graphics.o
clean:
